	...
	<div class="container">
		<div class="card card-outline rounded-0 card-navy">
			<div class="card-header">
				<h4 class="font-weight-bolder">Atualizar detalhes de utilizador</h4>
			</div>
			<div class="card-body">
					...
					<form action="" id="manage-user">	
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="form-group">
									<label for="cpassword" class="control-label">Confirmar Nova Password</label>
									<div class="input-group input-group-sm">
										<input type="password" class="form-control form-control-sm rounded-0" id="cpassword">
										<button tabindex="-1" class="btn btn-outline-secondary btn-sm rounded-0 pass_view" type="button"><i class="fa fa-eye-slash"></i></button>
									</div>
								</div>
								<small class="text-muted"><i>Se não deseja mudar a password deixe o espaço de password em branco.</i></small>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-sm btn-primary btn-sm btn-flat" form="manage-user">Atualizar</button>
			</div>
		</div>
	</div>
</section>
